...
**Hybrid enrichment** — don't replace MSPN's systems, extend them:

1. Port RepuNet's reputation model as a pluggable alternative/extension to MSPN's karma
2. Add gossip and social network as new optional modules
3. Scale from 2 agents to N agents
4. Keep MSPN's causal logging, stats, and visualization infrastructure
